...
@WebServlet(name = "helloServlet", value = "/VenderItem")
public class VenderItem extends HttpServlet{
        ...
        public void venderitem(HttpServletRequest request) throws IOException {
        ...
        public void vendas(HttpServletRequest request) throws IOException {
